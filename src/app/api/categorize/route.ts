...
const DOMAIN_HINTS: { words: string[]; domains: string[] }[] = [
  {
    words: ["meeting", "prd", "sprint", "okr", "review", "deploy", "stakeholder",
      ...
      "pipeline", "experiments", "hiring", "partnerships", "cash flow", "invoicing",
      "action items", "shoutouts", "proposals", "outreach", "compliance"],
    domains: ["work", "career", "strategy", "execution", "stakeholder", "product", "sprint",
      "roadmap", "backlog", "pioneer", "maker", "strategist", "coach", "explorer"],
  },
  {
